...
export default function ProductList() {
  ...
  return (
    <section className="container mx-auto mt-12 ">
      <h2 className="text-4xl font-bold mb-4 text-center text-green-500 pt-4">Product List</h2>
        ...
        {loading ? (
          ...
          currentProducts.map((product) => (
            <Link legacyBehavior key={product.id} href={`/product-details/${product.id}`}>
              <a className="w-full bg-gradient-to-l from-slate-300 to-slate-100 text-slate-600 border border-slate-300 p-4 rounded-lg shadow-md hover:bg-gray-100 transform transition-transform hover:scale-105">
                <div className="text-lg font-bold capitalize mb-2 text-center">
                {product.name}
                </div>
